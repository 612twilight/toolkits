...
def recu_list_dirs_by_dictionary_order(path, indent=0, maxi=-1, print_file=False):
    '''
    ...
    if maxi != 0:
        try:
            ...
            for item in lsdir:
                ...
                if os.path.isfile(full_path) and print_file:
                    print(' ' * indent, '-', item)


if __name__ == '__main__':
    recu_list_dirs_by_dictionary_order("E:\dl_lab_toolkits\datasets\ccks2021面向保险领域的低资源文档信息抽取")
