...
File Name: google_translator_api.py
Author: gaoyw
...
def translate(text,origin="zh-CN",to="ug"):
    key = text
    # 获取Py4Js实例
    py = Py4Js()
    ...
    # 请求的URL
    url = "https://translate.google.cn/translate_a/single?client=webapp&sl=" + origin + "&tl=" + to + "&hl=zh-CN" \
